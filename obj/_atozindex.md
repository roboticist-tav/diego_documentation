...
| `apparat`*[us]* <a name="apparat"></a>| A technical *device* `thingy`, carried/worm by a human, for use for a particular purpose or activity. An `apparatus` should have access to the _puff_. The human version of a `sensor`.<br>Example: geiger counter, multi-meter; *a handheld device*<br>See also: [sensor](#sensor)| [apparatus](/apparat.md)
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQ3NjMzMjMzOSwxNjkyMTEyOTk3LDIxND
E3MTAwNjFdfQ==
-->