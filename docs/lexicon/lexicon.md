...
| --- | --- | --- | --- |
| <a name="?_a"></a> *`<comand>`*`;` | abstract | *statement-operator* | [Termination](../abstract/special/semicolon.md) of preceeding *statement* |
| <a name="?_b"></a> `? `*`<command>`* | abstract | *statement-operator* | Termination of preceeding *statement* and the [positive outcome](../abstract/special/elvish.md) beginning of proceeding *statement* |
| <a name="?_c"></a> `| `*`<command>`* | abstract | *statement-operator* | Termination of preceeding *statement* and the [neutral outcome](../abstract/special/elvish.md) beginning of proceeding *statement* |
| <a name="?_d"></a> `: `*`<command>`* | abstract | *statement-operator* | Termination of preceeding *statement* and the [negative outcome](../abstract/special/elvish.md) beginning of proceeding *statement* |
...
| <a name="(_b"></a> `[`*`variablemoniker`*`]`<br>`[]`<br>`[`*`moniker`*`]`<br>`_`*`<expressionposit>`*`([`*`ordinal`*`])` | abstract<br>metaphysic<br>physic | *object*<br>*variable* | Refer to *variable* *object* *variablemoniker*<br>Refere to last scoped *variable* or 'this' parent scoped *object*<br>Refer to object *moniker*<br>Refer the ordinal *variable* *object* at position *ordinal* from the proceeding *object* |
| <a name="(_c"></a> `([`*`variablemoniker`*`])`<br>`({datatype},[`*`variablemoniker`*`])` | abstract<br>metaphysic<br>physic | *object* |  Refer to *variable* *object* of value of *variablemoniker*<br>Refere to *variable* *object* of value of *variablemoniker* to datatype *datatype* |
| <a name="{}"></a> `{`*`datatype`*`}`<br>`{`*`type`*`}`<br>`{}` | abstract<br>metaphysic<br>physic | *statement* | [Datatype](../abstract/statem/datatype.md) declaration or cast of datatype *datatype*<br>[Type](../metaphysic/statem/type.md) declaration or cast of type *type*<br>Declare or cast variant datatype or variant type |
...
| <a name="at"></a> `_at(`*`tempor`*`)` | abstract | *condit* | Preceeding *object* [at](../abstract/condit/at.md) [tempor](../abstract/obj/tempor.md) for proceeding *object* to do proceeding *action* |
| <a name="attr"></a> `attr`<br>`attribute` | metaphysic | *object* | Example: <br>See also: [spec](#spec) | [attr](../metaphysic/obj/attr.md) |
| <a name="before"></a> `_before(`*`tempor`*`)` | abstract | *condit* | Preceeding *object* [before](../abstract/condit/before.md) [tempor](../abstract/obj/tempor.md) for proceeding *object* to do proceeding *action* |
...
| <a name="day"></a> `_day()`<br>`_day(`*`day_numeric`*`)` | abstract | property | References the temporal [day](../abstract/prop/day.md) of the preceeding *object*<br><br>Sets the temporal  [day](../abstract/prop/day.md) of *day_numeric* |
...
| <a name="during"></a> `_during(`*`tempor`*`)` | abstract | *condit* | Preceeding *object* [during](../abstract/condit/during.md) [tempor](../abstract/obj/tempor.md) for proceeding *object* to do proceeding *action* |
...
| <a name="fortnight"></a> `_fortnight()` &nbsp; `_fortn()`<br>`_fortnight(`*`fortnnumeric`*`)` &nbsp; `_fortn(`*`fortnnumeric`*`)` | abstract | property | References the temporal fortnight of the preceeding *object*<br><br>Sets the temporal fortnight of *fortnnumeric* | [fortn](../abstract/prop/fortn.md) |
| <a name="fqtr"></a> `_fqtr()` &nbsp; `_fiscalquarter()`<br>`_fqtr(`*`fqtr_numeric`*`)` &nbsp; `_fiscalquarter(`*`fqtr_numeric`*`)` | abstract | property | References the fiscal quarter year of the preceeding *object*<br>Sets the fiscal quarter year of *qtr_numeric* | [fqtr](../abstract/prop/fqtr.md) |
...
| <a name="hour"></a> `_hour()` &nbsp; `_hr()`<br>`_hour(`*`hr_numeric`*`)` &nbsp; `_hour(`*`hr_numeric`*`)`<br>`❬hour❭` &nbsp; `❬hr❭` | abstract | property | References the temporal hour of the preceeding *object*<br>Sets the temporal hour of *hr_numeric*<br>Hour unit | [hour](../abstract/prop/hr.md) |
...
| <a name="dt_a"></a> `{bit}` &nbsp; `{byte}` &nbsp; `{octet}` &nbsp; `{word}` | abstract | *datatype* | Computer primiative datatypes |
...
| <a name="jour"></a> `_jour()`<br>`_jour(`*`jour_numeric`*`)`<br>`_jour(`*`jour_sring`*`)` | abstract | property | References the temporal jourday of the preceeding *object*<br>Sets the temporal jourday of *jour_numeric* or *jour_string* | [jour](../abstract/prop/jour.md) |
...
| <a name="microsec"></a> `_μs()` &nbsp; `_microsecond()`<br>`_μs(`*`μs_numeric`*`)` &nbsp; `_microsecond(`*`μs_numeric`*`)`<br>`❬microsec❭` &nbsp; `❬microsecond❭` &nbsp; `❬μs❭` | abstract | property | References the temporal [microsecond](../abstract/prop/μs.md) of the preceeding *object*<br>Sets the temporal [microsecond](../abstract/prop/μs.md) of *μs_numeric*<br>[Microsecond](../abstract/dt/μs.md) unit |
| <a name="millisec"></a> `_ms()`<br>`_millisecond()`<br>`_ms(`*`ms_numeric`*`)`<br>`_millisecond(`*`ms_numeric`*`)` | abstract | property | References the temporal millisecond of the preceeding *object*<br><br>Sets the temporal millisecond of *ms_numeric* | [millisecond](../abstract/prop/ms.md) |
| <a name="min"></a> `_min()`<br>`_minute()`<br>`_min(`*`min_numeric`*`)`<br>`_minute(`*`min_numeric`*`)` | abstract | property | References the temporal minute of the preceeding *object*<br><br>Sets the temporal minute of *min_numeric* | [min](../abstract/prop/min.md) |
...
| <a name="mode"></a> `mode` | |
| <a name="month"></a> `_month()`<br>`_mth()`<br>`_month(`*`mthnumeric`*`)`<br>`_mth(`*`mthnumeric`*`)`<br>`_month(`*`mth_string`*`)`<br>`_mth(`*`mth-string`*`)` | abstract | property | References the temporal month of the preceeding *object*<br><br>Sets the temporal month of *mthnumeric* or *mth_string* | [month](../abstract/prop/month.md) |
...
| <a name="qtr"></a> `_qtr()` &nbsp; `_quarter()`<br>`_qtr(`*`qtr_numeric`*`)` &nbsp; `_quarter(`*`qtr_numeric`*`)` | abstract | property | References the temporal quarter year of the preceeding *object*<br><br>Sets the temporal quater year of *qtr_numeric* | [qtr](../abstract/prop/qtr.md) |
...
| <a name="scan"></a> `scan` | |
| <a name="sec"></a> `_sec()`<br>`_second()`<br>`_sec(`*`sec_numeric`*`)`<br>`_second(`*`sec_numeric`*`)` | abstract | property | References the temporal second of the preceeding *object*<br><br>Sets the temporal second of *sec_numeric* | [sec](../abstract/prop/sec.md) |
...
| <a name="sub"></a> `sub(`*`moniker`*`)` | physic | *object* | A unidentified mobile physical [ject](sub.md) |
| <a name="subject"></a> `subject(`*`moniker`*`)` | physic | *object* | A dumb mobile physical [ject](subject.md) |
...
| <a name="week"></a> `_week()` &nbsp; `_wk()`<br>`_week(`*`wknumeric`*`)` &nbsp; `_wk(`*`wknumeric`*`)` | abstract | property | References the temporal week of the preceeding *object*<br><br>Sets the temporal week of *wknumeric* | [week](../abstract/prop/week.md) |
...
| <a name="year"></a> `_year()`<br>`_year(`*`yearnumeric`*`)` | abstract | property | References the temporal year of the preceeding *object*<br>Sets the temporal year of *yearnumeric* | [year](../abstract/prop/year.md) |
